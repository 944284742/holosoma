...
# globally-sourced isaaclab/isaacsim setup) so they don't shadow this venv.
...
# DDS/runtime, and the unitree interface crashes with "free(): invalid pointer" at
# DDS init. Prepend the bundled lib dir so unitree's DDS wins the ABI.
