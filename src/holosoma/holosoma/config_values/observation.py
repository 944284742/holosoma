...
from holosoma.config_values.loco.xhum_v2.observation import xhum_v2_31dof_loco_single_wolinvel
...
DEFAULTS = {
    ...
    "xhum_v2_31dof_loco_single_wolinvel": xhum_v2_31dof_loco_single_wolinvel,
}
