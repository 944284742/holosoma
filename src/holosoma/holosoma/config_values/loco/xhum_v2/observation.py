"""Locomotion observation presets for the xhum_v2 robot."""

from holosoma.config_types.observation import ObservationManagerCfg, ObsGroupCfg, ObsTermCfg

xhum_v2_31dof_loco_single_wolinvel = ObservationManagerCfg(
    groups={
...
__all__ = ["xhum_v2_31dof_loco_single_wolinvel"]
