"""Locomotion curriculum presets for the xhum_v2 robot."""

from holosoma.config_types.curriculum import CurriculumManagerCfg, CurriculumTermCfg

xhum_v2_31dof_curriculum = CurriculumManagerCfg(
    params={
...
xhum_v2_31dof_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
...
__all__ = ["xhum_v2_31dof_curriculum", "xhum_v2_31dof_curriculum_fast_sac"]
